<x-layout>
  <div class="container py-md-5 container--narrow">
    <div class="d-flex justify-content-between">
      ...
      {{-- TO THE POLICY RETURN TRUE OR FALSE,call update which received the current_user and the post_user --}}
      @can('update', $post)
      <span class="pt-2">
    ...
    <p class="text-muted small mb-4">
      ...
      {{-- $post which the date received, user is the function in the model, and username is from the table name --}}
    </p>

    <div class="body-content">
      {{-- DONT ESCAPE THE CONTENT --}}
       {!! $post->body !!}
  </div>
</x-layout>